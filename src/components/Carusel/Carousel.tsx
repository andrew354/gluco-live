...
const Carousel = () => {
  ...
  return (
    <div className="carousel my-12 mx-auto">
      <h2 className="mb-12 text-4xl font-semibold leading-8 text-slate-700">Our epic carousel</h2>
      <div className="relative overflow-hidden">
        ...
        >
          {data.resources.map((resource, index) => {
            return (
              <div key={index} className="carousel-item relative h-64 w-64 snap-start text-center">
                <a
                  href={resource.link}
                ...
                >
                  <h3 className="mx-auto py-6 px-3 text-xl text-white">{resource.title}</h3>
                </a>
              </div>
            );
          })}
